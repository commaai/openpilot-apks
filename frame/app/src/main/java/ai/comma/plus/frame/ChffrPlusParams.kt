    ...
    companion object {
        ...
        fun lockParams() {
            try {
                ...
                Log.e("frame", "ChffrPlusParams.lockParams", e)
            }
        }
        ...
        fun unlockParams() {
            try {
                ...
                Log.e("frame", "ChffrPlusParams.unlockParams", e)
            }
        }
        ...
        fun readParam(paramName: String): String? {
            try {
                ...
                Log.e("frame", "ChffrPlusParams.readParam", e)
                return null
            }
        }
        ...
        fun writeParam(paramName: String, value: String) {
            ...
            try {
                ...
                Log.e("frame", "ChffrPlusParams.writeParam", e)
                tmpFile?.delete()
            }
            unlockParams()
        }
