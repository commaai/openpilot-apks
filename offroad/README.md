...
Note: CLI builds fail if the gradle daemon is running. Android Studio's gradle daemon has a separate JDK environment and class lookups begin to fail (see: java.lang.ClassNotFoundException: com.sun.tools.javac.util.Context)
